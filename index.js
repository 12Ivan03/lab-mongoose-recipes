...
mongoose
  ...
  //   title: 'Carbonara',
  //   level: 'Easy Peasy',
  //   ingredients: ['egs', 'parmesan', 'spagetti', 'pancetta'],
  //   cuisine: 'Italian',
  //   dishType: 'main_course',
  //   duration: 20,
  //   creator: 'Food historian Luca Cesari states, carbonara was born in Rome around 1944.'
  // }))
  // .then((createdRecipe) => {
  ...
  //   }
  // ]))
  //   .then((createMany) => console.log("Create Many", createMany))
  ...
  // .then((updateDuration) => console.log(updateDuration))
  // .then(() => mongoose.connection.close())
  // .catch(err => console.log(err))


  // <<>><<>><<>><<>><<>><<>><<>><<>><<>>
  //    iteration 5 - Update recipes
  // <<>><<>><<>><<>><<>><<>><<>><<>><<>>
  ...
  // <<>><<>><<>><<>><<>><<>><<>><<>><<>>
  // The DataBase is close everytime after each of the iterations.
  // .then(() => mongoose.connection.close())